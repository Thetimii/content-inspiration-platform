 ...
 * This version uses the video_url content type with Qwen2.5-VL
 */
export async function POST(request: Request) {
  try {
    ...
    console.error('Unexpected error in direct-analyze-video-url route:', error);
...
Be specific and detailed in your analysis.`;
    ...
    try {
      ...
      console.log('Making OpenRouter API call with model: qwen/qwen2.5-vl-72b-instruct');
