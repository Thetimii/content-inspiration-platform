...
export default function DirectTestPage() {
  ...
  // Function to analyze a video using the direct approach
  const analyzeVideo = async (videoId: string) => {
    ...
    try {
      // Call the analyze-video-simple endpoint directly
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Direct Video Analysis Test</h1>
        <p className="text-gray-300 mb-8">
          This page uses the original direct approach that worked before, but with the free model.
        </p>
                  ...
                  <div className="w-full md:w-2/3">
                    ...
                    {video.summary ? (
                      ...
                      <div className="bg-gray-900 rounded p-4 text-gray-500 italic">
                        No analysis available. Click "Analyze Video Directly" to generate one.
                      </div>
                    )}
                  </div>
                </div>
